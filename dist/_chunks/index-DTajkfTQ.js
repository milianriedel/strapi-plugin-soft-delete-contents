...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, {});
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-D07FEbY6.js"));
        return App;
      }
    });
    app.registerPlugin({
  ...
  async registerTrads(app) {
    ...
    const importedTranslations = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-Dcd_tWCL.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-CEhPC_N7.js")) }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
