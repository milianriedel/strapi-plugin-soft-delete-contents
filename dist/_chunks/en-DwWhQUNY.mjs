...
const en = {
  ...
  cancel,
  save,
  "explorer.searchContentTypes": "Search Content Types",
  "explorer.collectionTypes": "Collection Types",
  "explorer.singleTypes": "Single Types",
  "explorer.draftPublish": "Draft & Publish",
  ...
  "setting.restorationBehavior.draftPublish.hint": "You can choose to restore an entry supporting Draft & Publish to a draft or unchanged.",
  "setting.restorationBehavior.draft": "Draft",
  "setting.restorationBehavior.unchanged": "Unchanged",
  "settings.save.success": "Settings saved successfully",
  "settings.save.error": "Error saving settings",
  "settings.load.error": "Error loading settings"
};
export {
  back,
  cancel,
